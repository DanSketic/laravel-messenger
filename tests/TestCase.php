...
class TestCase extends Orchestra
{
    ...
    {
        $app['config']->set('messenger.message_model', 'DanSketic\Messenger\Models\Message');
        $app['config']->set('messenger.participant_model', 'DanSketic\Messenger\Models\Participant');
        $app['config']->set('messenger.thread_model', 'DanSketic\Messenger\Models\Thread');
    }
